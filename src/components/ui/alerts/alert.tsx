...
const alertVariants = cva(
  "relative flex w-[50%] items-start gap-3 rounded-lg border p-4 text-sm transition-all",
  {
    variants: {
      type: {
        success: "border-green-500 bg-green-100 text-green-700 rounded-xl",
        error: "border-red-500 bg-red-100 text-red-700 rounded-xl",
        warning: "border-yellow-500 bg-yellow-100 text-yellow-800 rounded-xl",
        info: "border-blue-500 bg-blue-100 text-blue-700 rounded-xl",
      },
      variant: {
